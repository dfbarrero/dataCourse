...
\begin{frame}{Other clustering algorithms}{Gaussian Mixure Model (GMM) (II)}
        Gaussian parameters are fit with the Expectation-Maximization (E-M) algorithm
            ...
            \end{itemize}
       GMM is a \textbf{generative model}
            \begin{itemize}
            \item The model is a probability distribution $\Rightarrow$ Just sample the distribution
            \end{itemize}
...
\begin{frame}{Other clustering algorithms}{DBSCAN (I)}
	...
	\begin{itemize}
        ...
        \item Asumption: Clusters form dense regions separated by empty areas
	\end{itemize}
    Hyperparameters
    \begin{itemize}
...
\begin{frame}{Other clustering algorithms}{Agglomerative clustering (II)}
    Agglomerative clustering is a special case of \alert{hierarchical clustering}
    
    \bigskip

	\centering \textbf{Dendrogram}\\ \includegraphics[width=0.5\linewidth]{figs/dendrogram.png}
