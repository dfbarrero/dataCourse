...
\begin{frame}{Algorithms}{K-means (V)}
    New data points are assigned to its closest centroid
    \begin{columns}
 	   \column{.5\textwidth}
       \begin{block}{K-means algorithm}
       \begin{enumerate}
        \item Set random centroids
        \item Assign each data point to its closest centroid
        \item Recompute centroids
        \item Repeat 2 until no point reassignment
       \end{enumerate}
       \end{block}
...
\begin{frame}[fragile]{Algorithms}{K-means (VI)}
    K-means drawbacks
    \begin{itemize}
        \item Initial seed
        \item K election
...
\begin{frame}[fragile]{Algorithms}{K-means: summary}
    \begin{columns}
        ...
        \begin{block}{Disadvantages}
           \begin{itemize}
            \item Spherical shapes
            \item Dependence on $k$
           \end{itemize} 
        \end{block}
    \end{columns}
