...
\begin{frame}{Dimensionality reduction}{Kernel PCA}
	...
	\includegraphics[width=0.4\linewidth]{figs/swiss.jpeg}\\
    \centering
...
\begin{frame}{Dimensionality reduction}{Manifold learning}
	...
	\includegraphics[width=0.8\linewidth]{figs/lle.png}
   	\centering \tiny{\href{https://github.com/Akramz/Hands-on-Machine-Learning-with-Scikit-Learn-Keras-and-TensorFlow/blob/master/08.Dim_Reduction.ipynb}{(Source)}}
\end{frame}

\subsection{Locally Linear Embedding (LLE)}
\begin{frame}{Dimensionality reduction}{Manifold learning}
	Measures how mach each training instance linearly relates to ists closest neighbors\\
    preservers local relations

	\includegraphics[width=0.7\linewidth]{figs/lle.png}
   	\centering \tiny{\href{https://github.com/Akramz/Hands-on-Machine-Learning-with-Scikit-Learn-Keras-and-TensorFlow/blob/master/08.Dim_Reduction.ipynb}{(Source)}}
\end{frame}

\subsection{Other manyfold techniques}
\begin{frame}{Dimensionality reduction}{Manifold learning}
    ...
    Isomap
        \begin{itemize}
        \item Preserves geodesic distance
        \end{itemize}
    t-Distributed Stochastic Neighbor Embedding (t-SNE)
        \begin{itemize}
        \item Preserves local distances and keep dissimilar instances apart
        \end{itemize}
        

	\includegraphics[width=0.8\linewidth]{figs/manifold.png}
   	\centering \tiny{\href{https://scikit-learn.org/0.21/auto_examples/manifold/plot_compare_methods.html}{(Source)}}
\end{frame}
