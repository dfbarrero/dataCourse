...
\begin{frame}{The data analysis process}{Data adquisition (I)}
...
\begin{frame}[fragile]{The data analysis process}{Data adquisition (II): CSV}
	\begin{columns}
 	  \column{.50\textwidth}
...
\begin{frame}[fragile]{The data analysis process}{Data adquisition (III): JSON}
	\begin{columns}
 	  \column{.30\textwidth}
...
\IfStrEq{\modo}{mcyte}{
\begin{frame}{The data analysis process}{Data adquisition (IV): Space data formats}
...
\IfStrEq{\modo}{mcyte}{
\begin{frame}{The data analysis process}{Data adquisition (V): Space data sources}
