...
\begin{frame}{Linear models}{ElasticNet}
	...
	\begin{itemize}
		...
		\item $\lambda$ balances L1 and L2
	\end{itemize}
\end{frame}
...
\begin{frame}{Linear models}{Linear models for classification}
    Three regularizations
	\begin{itemize}
...
\subsection{Summary}
\begin{frame}{Linear models}{Summary (I)}
	\begin{center}
    Linear regression
	\begin{tabular}{cp{3cm}p{3cm}}\hline
	 	\texttt{Hyperparameters}  & \texttt{Advantages}  & \texttt{Disadvantages} \\\hline
...
\begin{frame}{Linear models}{Summary (II)}
	\begin{center}
    Lasso regression
	\begin{tabular}{cp{3cm}p{3cm}}\hline
	 	\texttt{Hyperparameters}  & \texttt{Advantages}  & \texttt{Disadvantages} \\\hline
