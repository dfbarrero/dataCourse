...
\section{Heliophysics research group}
\begin{frame}{Case studies}{Case study 2: Research group data management}
	Client
	\begin{itemize}
		\item Space Weather Group 
	\end{itemize}
	Business problem
	\begin{itemize}
		\item Multiple data sources for Heliophysics
        \item Multiple researchers
        \item Multiple -critical- services (www.senmes.es)
	\end{itemize}
	Data
	\begin{itemize}
		\item Instrumentation: Radio telescope, magnetometer, GNSS, VLF antenna, H$\alpha$ telescope, ...
        \item External sources: SDO, GOES, STEREO, ...
