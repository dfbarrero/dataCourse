...
\begin{frame}{Introduction}{History}
	...
	\item[1956] \textit{Dartmouth workshop}. AI is introduced 
...
\begin{frame}{Introduction}{Biological neurons (I)}
	...
	A signal may propagate from dentrites to synapses
		\begin{itemize}
		\item The synapses release a chemical named \textit{neurotransmitter}
		\item Given enougth neurotransmitters, a neuron fires
		\end{itemize}
\end{frame}
