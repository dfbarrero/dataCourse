...
\begin{frame}{Convolutional Neural Networks}{Object detection: You Only Look Once (YOLO)}
	...
	\begin{itemize}
		...
		\item \href{https://docs.ultralytics.com/}{(Yolo v26)}
...
\begin{frame}{Advanced topics}{Generative networks: GANs}
...
\subsection{Stable difussion}

\begin{frame}{Advanced topics}{Generative networks: Stable difussion}
	\centering\includegraphics[width=\linewidth]{figs/stable-difussion.png}\\
	\scriptsize\href{https://medium.com/design-bootcamp/how-stable-diffusion-works-explained-for-non-technical-people-be6aa674fa1d}{(Source)}
\end{frame}
...
\begin{frame}[plain,fragile]{Advanced topics}{Large Language Models (LLMs): Operation}
\begin{columns}
  \begin{column}{0.4\textwidth}
        \begin{alertblock}{AI generated}
        Unverified content
    \end{alertblock}
  \end{column}
  \begin{column}{0.5\textwidth}
	%\centering\input{figs/como_funciona_claude.tex}\\
    \vspace{-1cm}
	\centering\includegraphics[width=\linewidth]{figs/como_funciona_claude.pdf}\\
	\scriptsize (Source: Claude)
  \end{column}
...
\begin{columns}
  ...
  \begin{column}{0.5\textwidth}
	%\centering\input{figs/como_funciona_claude.tex}\\
    \vspace{-1cm}
	\centering\includegraphics[width=\linewidth]{figs/entrenamiento_claude.pdf}\\
	\scriptsize (Source: Claude)
  \end{column}
  \begin{column}{0.1\textwidth}
  \end{column}
